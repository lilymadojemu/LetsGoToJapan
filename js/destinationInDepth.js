...
// A set Housing destinations saved to the itinerary page (no duplicates)
let itineraryList = new Set();
...
function createDestination(destinationInfo) {
    ...
    destinationTopTitle.textContent = 'Welcome to ' + destinationInfo.title + '!';
    // Destination Tagline
